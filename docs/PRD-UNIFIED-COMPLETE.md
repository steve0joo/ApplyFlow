...
**Status:** Phase 0 Complete - In Development
...
|-------|------------|-----------|
| **Frontend** | Next.js 14 (App Router) | Server components, full-stack, Vercel native |
...
| **LLM** | Vercel AI SDK | Unified API for Anthropic/OpenAI |
...
│     (Plasmo)        │    │    (Next.js 14)     │    │  (Auto-forward)     │
└──────────┬──────────┘    └──────────┬──────────┘    └──────────┬──────────┘
           │                          │                          │
           │                          │                          │
           └────────────┬─────────────┘                          │
...
### 3.3 Phase 1: Extension (Week 3-4)

**Goal:** One-click job saving from LinkedIn and Greenhouse

**Deliverables:**
- [ ] Plasmo scaffold
- [ ] LinkedIn job page detector + extractor
- [ ] Greenhouse job page detector + extractor
- [ ] Extension popup UI
...
### 3.4 Phase 2: Email Tracking (Week 5-7)

**Goal:** Automatic status updates from forwarded emails

**Deliverables:**
- [ ] SendGrid Inbound Parse configuration
- [ ] Unique inbound address generation per user
- [ ] Inngest setup + email processing function
- [ ] ATS-aware company matching
- [ ] LLM classification with Vercel AI SDK
- [ ] Confidence threshold handling
- [ ] Email history per application
- [ ] Unmatched email queue
- [ ] Email setup onboarding flow
...
### 3.5 Phase 3: BYOA & Polish (Week 8-9)

**Goal:** Self-serve API configuration, polished UX

**Deliverables:**
- [ ] 2-step setup wizard (Supabase → LLM)
- [ ] API connection validators
- [ ] Credential encryption
- [ ] Kanban board with drag-drop
- [ ] Advanced filters and search
- [ ] Status timeline view
- [ ] Additional job boards (Indeed, Lever, Wellfound)
- [ ] Error handling + toasts
- [ ] Help documentation

### 3.6 Phase 4: AI Analysis (Week 10)

**Goal:** Basic AI-powered insights (MVP version)

**Deliverables:**
- [ ] Analysis filters (time period, job type)
- [ ] Inngest analysis job
